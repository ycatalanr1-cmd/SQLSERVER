...
**Dónde hacerlo:** En **Nombre del paso**, escribir `Registrar ejecución`.&#x20;

En **Tipo**, dejar seleccionado **Script Transact-SQL (T-SQL)**, que es el tipo por defecto para ejecutar comandos T-SQL.

## Seleccionar la base de datos

**Qué hacer:** Indicar sobre qué base de datos se ejecutará el comando del paso.

**Dónde hacerlo:** En el campo **Base de datos**, seleccionar `AgenteSQLDemo`&#x20;

<figure><img src="../.gitbook/assets/03-nuevo-paso-general.png" alt="Cuadro Nuevo paso de trabajo, página General, con el nombre Registrar ejecución, tipo Script Transact-SQL y base de datos AgenteSQLDemo, comando vacío"><figcaption><p>Configuración inicial del paso Registrar ejecución, antes de escribir el comando.</p></figcaption></figure>
...
**Resultado esperado:** El paso `Registrar ejecución` aparece en la lista de **Pasos guardados** del Job, con el tipo _Script Tr..._ (Transact-SQL), la acción "Ir al siguiente paso" en caso de éxito y "Salir del trabajo" en caso de error.

<figure><img src="../.gitbook/assets/05-pasos-guardados.png" alt="Lista de pasos guardados del Job, mostrando el paso Registrar ejecución"><figcaption><p>El paso Registrar ejecución ya guardado en la lista de pasos del Job.</p></figcaption></figure>
