# 5. Ejecutar y verificar el Job

Aunque el Job ya quedó programado para ejecutarse todos los días, no es necesario esperar a la hora programada para comprobar que funciona: se puede iniciar manualmente en cualquier momento.
...
<figure><img src="../.gitbook/assets/07-iniciar-trabajo-correcto.png" alt="Cuadro Iniciar trabajos, mostrando Correcto, 2 de 2 acciones correctas"><figcaption><p>El Job Demo_SQL_Agent se ejecutó correctamente.</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/08-verificacion-select.png" alt="Resultado de la consulta SELECT * FROM dbo.AgentDemoLog mostrando una fila con fecha y mensaje"><figcaption><p>La consulta confirma que el paso del Job insertó el registro esperado.</p></figcaption></figure>
